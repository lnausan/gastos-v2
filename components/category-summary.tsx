...
const LOCAL_CATEGORIES = [
  ...
  { id: "cedears", name: "CEDEARS", color: "#065f46" },
  { id: "acc", name: "ACC", color: "#7f1d1d" },
  { id: "finanzas", name: "Finanzas", color: "#7c2d12" },
  { id: "sueldo", name: "Sueldo", color: "#7c2d12" },
  { id: "ingreso", name: "Ingreso", color: "#78350f" },
  { id: "alimentacion", name: "Alimentación", color: "#4b006e" },
  { id: "transporte", name: "Transporte", color: "#334155" },
  { id: "entretenimiento", name: "Entretenimiento", color: "#0f172a" },
  { id: "salud", name: "Salud", color: "#3f3f46" },
  { id: "educacion", name: "Educación", color: "#27272a" },
  { id: "vivienda", name: "Vivienda", color: "#1e3a8a" },
  { id: "servicios", name: "Servicios", color: "#065f46" },
  { id: "ropa", name: "Ropa", color: "#7f1d1d" },
  { id: "tecnologia", name: "Tecnología", color: "#7c2d12" },
  { id: "otros", name: "Otros", color: "#78350f" },
]
